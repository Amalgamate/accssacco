...
(function ($) {
	...
	var showSwitcher = false; // Disable demo switcher
	/*
	...
	*/
	...
	var mainMenuContent = $(".main-header .main-menu .navigation").html();
	if (mainMenuContent) {
		$(".sticky-header .navigation").append(mainMenuContent);
	}
	if ($(".mobile-menu").length) {
		$(".mobile-menu .navigation").append(mainMenuContent);
